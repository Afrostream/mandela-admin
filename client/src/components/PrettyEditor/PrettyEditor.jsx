...
class PrettyEditor extends Component {
  constructor(props) {
    super(props);
...
//   constructor(props) {
//     super(props);
//     this.state = {editorState: EditorState.createEmpty(), textAlignment: 'left'};
//     this.onChange = (editorState) => this.setState({editorState});
//     this.onAlign = (direction) => this.setState({textAlignment: direction || 'left'})
...
//   _onBoldClick() {
//     this.onChange(RichUtils.toggleInlineStyle(this.state.editorState, 'UPPERCASE'));
//   }
...
//         <button onClick={this._alignLeft.bind(this)}>Left</button>
//         <button onClick={this._alignCenter.bind(this)}>Center</button>
//         <button onClick={this._alignRight.bind(this)}>Right</button>
